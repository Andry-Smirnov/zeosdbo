...
begin
  { MultiByte }
  AddCodePage('TIS-620', 1, ceAnsi, 874); {Windows Thailдndisch, ISO8859-11, binдre Sortierung}
  ...
  AddCodePage('UTF-8', 7, ceUTF8, zCP_UTF8, '', 3); {UTF-8, 8-Bit-Mehrbyte-Zeichensatz fьr Unicode, binдre Reihenfolge}
  ...
  AddCodePage('Windows-1254', 12, ceAnsi, 1254); {Windows Tьrkisch, ISO8859-9 mit Erweiterungen}
  AddCodePage('Windows-1255', 13, ceAnsi, 1255); {Windows Hebrдisch, ISO8859-8 mit Erweiterungen}
  ...
  AddCodePage('ISO_8859-2:1987', 18, ceAnsi, 1251); {Zentral- und Osteuropдisch}
  //ISO-8859-15 //ISO9LATIN1
  //ISO_8859-7:1987 //Griechisch
  //ISO_8859-8:1988 //Hebrдisch
  ...
  AddCodePage('ISO_8859-9:1989', 21, ceAnsi, 920); //Tьrkisch
end;
